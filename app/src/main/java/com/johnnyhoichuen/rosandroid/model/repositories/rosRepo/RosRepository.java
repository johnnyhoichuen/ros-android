package com.johnnyhoichuen.rosandroid.model.repositories.rosRepo;
...
import com.johnnyhoichuen.rosandroid.model.entities.widgets.IPublisherEntity;
import com.johnnyhoichuen.rosandroid.model.entities.widgets.ISilentEntity;
import com.johnnyhoichuen.rosandroid.model.entities.widgets.ISubscriberEntity;
import com.johnnyhoichuen.rosandroid.model.repositories.rosRepo.connection.ConnectionCheckTask;
import com.johnnyhoichuen.rosandroid.model.repositories.rosRepo.connection.ConnectionListener;
import com.johnnyhoichuen.rosandroid.model.repositories.rosRepo.connection.ConnectionType;
...
import com.johnnyhoichuen.rosandroid.model.repositories.rosRepo.node.AbstractNode;
...
import com.johnnyhoichuen.rosandroid.model.repositories.rosRepo.node.NodeMainExecutorService;
import com.johnnyhoichuen.rosandroid.model.repositories.rosRepo.node.NodeMainExecutorServiceListener;
import com.johnnyhoichuen.rosandroid.model.repositories.rosRepo.node.PubNode;
import com.johnnyhoichuen.rosandroid.model.repositories.rosRepo.node.SubNode;
 ...
 * @modified by Nico Studt
 */
public class RosRepository implements NodeListener {
...
//        currentNodes.put(temiTfTopic, temiTfNode);
    ...
    public void onNewMessage(RosData data) {
        ...
        if (data.getMessage() instanceof TFMessage) {
            TFMessage tf = (TFMessage) data.getMessage();
...
//            Timber.tag("ros repo").d("onNewMessage: %s", data.getTopic().name);
            Log.d(TAG, "onNewMessage: " + data.getTopic().name);
        }

        this.receivedData.postValue(data);
    }
